  ...
  .page-single-post
    section.post
      h1.post-title {{ loadedPost.title }}
        .post-info
          span.post-data {{ loadedPost.author }}
          span.post-author {{ loadedPost.updatedDate }}
    ...
    section.post-feedback
      p
        ...
        a(href="mailto:duwkeksldpf@naver.com") duwkeksldpf@naver.com
        | 로 문의주세요.
</template>
      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: `${postTitle.title} - 포스트 보기`
        }
      ]
    }
  },
